...
from game_touches_help.get_game_touches_help_img import get_pygame_img, CreateImage
import pygame
pygame.init()


# Game touches help
space_bar_img = get_pygame_img(CreateImage(PSEUDO_WHITE, {"Press to Jump": "space"}, font_size=38))
ratio = space_bar_img.get_width() / space_bar_img.get_height()
space_bar_img = pygame.transform.scale(space_bar_img, (WIDTH/4, (WIDTH/4) / ratio))
...
class Game:
    ...
    def draw_choice(self):
        ...
        self.screen.blit(space_bar_img, ((WIDTH-space_bar_img.get_width())/2, HEIGHT/1.7))
